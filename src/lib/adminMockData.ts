...
export const TICKETS: SupportTicket[] = [
  ...
  { id: 'TK-005', userId: '12', userName: 'James Brown', email: 'james.b@hotmail.com', subject: 'Feature request: LinkedIn integration', description: 'It would be great if Jobwhisper could directly import my LinkedIn profile to build my resume.', category: 'feature_request', priority: 'low', status: 'open', createdAt: '2026-07-06T11:30:00Z', updatedAt: '2026-07-06T11:30:00Z' },
