    ...
    <MarketingLayout>
      <section className="pt-24 pb-16 bg-gradient-to-b from-[#f0f7ff] to-white">
        <div className="mx-auto max-w-6xl px-6 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-slate-600">
            Jobwhisper helps you beat the competition by applying faster and smarter, with each application
      ...
      <section className="py-8">
        <div className="mx-auto max-w-4xl px-6">
          <img src="/jobwhisper-home/images/autoApplyHeroSection.gif" alt="Auto Apply" className="w-full rounded-xl shadow-lg" />
        </div>
      </section>

      {[
        { title: 'Job Profile', subtitle: 'Create job profile', desc: 'Create job profile with your professional details, skills, experience, and preferences, to help us match you with relevant jobs that fits your skills and expertise. Our system allows you to create multiple job profiles.', image: '/jobwhisper-home/images/jobProfile.gif' },
        { title: 'Matched jobs', subtitle: 'Get matched with Jobs that fit your skill', desc: 'Let our system do the work and get you jobs that match your skills, ensuring you are ahead and helping you to automatically apply before other candidates even see the opening.', image: '/jobwhisper-home/images/matchedJobs.gif' },
        { title: 'Cover Letters', subtitle: 'Precise cover letter for every application', desc: 'With your permission, Auto-Apply can create customized cover letter for every apply, allowing you sound unique every time you apply.', image: '/jobwhisper-home/images/autoapply3.png' },
        { title: 'Applications', subtitle: 'View your Auto-applied jobs', desc: 'By applying to the right jobs consistently, you maximize your chances of landing interviews and securing the job you want without the exhausting manual work.', image: '/jobwhisper-home/images/autoAppliedJobs.gif' },
        { title: 'Job Tracker', subtitle: 'Never be left in the dark with Job Tracker', desc: 'Tired of wondering what happens after you apply? Now you can monitor every application with our job tracker.', image: '/jobwhisper-home/images/autoapply2.png' },
      ].map((item, i) => (
      ...
      <section className="py-16 bg-slate-50">
        <div className="mx-auto max-w-6xl px-6">
          <h2 className="text-3xl font-bold text-center text-slate-900">Why use Jobwhisper Auto-Apply?</h2>
