      ...
      <section className="pt-24 pb-16">
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="prose prose-slate mt-8 max-w-none text-sm leading-7 text-slate-700">
            ...
            <p>
              Jobwhisper ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains
              how your personal information is collected, used, and disclosed by Jobwhisper.
            </p>
            <p>
              This Privacy Policy applies to our app, and its associated subdomains (collectively, our "Service")
              alongside our application, Jobwhisper. By accessing or using our Service, you signify that you have
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li><strong>Company:</strong> refers to Jobwhisper LLC, (Dallas, USA).</li>
              <li><strong>Country:</strong> where Jobwhisper is based, in this case is USA.</li>
              <li><strong>Customer:</strong> refers to the company, organization or person that signs up to use the Jobwhisper Service.</li>
              ...
              <li><strong>Service:</strong> refers to the service provided by Jobwhisper as described in the relative terms.</li>
            </ul>
            ...
            <p>
              Jobwhisper uses "Cookies" to identify the areas of our app that you have visited. A Cookie is a small
