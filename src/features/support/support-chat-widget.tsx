...
function SupportFab({ onClick }: { readonly onClick: () => void }) {
  return (
    <button
      ...
      className="group fixed bottom-4 end-4 z-sticky flex items-center gap-2.5 rounded-full bg-accent px-4 py-3 text-sm font-semibold text-on-accent shadow-xl transition-all duration-200 hover:bg-accent-hover hover:shadow-2xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus focus-visible:ring-offset-2"
    >
