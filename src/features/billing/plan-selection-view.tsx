...
function PlanCard({
  ...
  // Annual billing does not apply to the weekly plan: it keeps its price and says so.
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col pt-5">
        ...
        {annual && plan.cadence === 'week' ? (
          <p className="mt-1 text-sm text-ink-muted">Annual billing does not apply to weekly plans</p>
        ) : null}
