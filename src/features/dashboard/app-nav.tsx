...
const APP_NAV_ENTRIES: readonly AppNavEntry[] = [
  ...
  { label: 'Job Directory', href: '/v3/job-directory', icon: <JobDirectoryIcon />, matchPrefix: '/v3/job-directory', dividerBefore: true },
  { label: 'Knowledge Base', href: '/v3/documents', icon: <KnowledgeBaseIcon />, matchPrefix: '/v3/documents' },
