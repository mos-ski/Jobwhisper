...
const applications: readonly AutoApplyJob[] = []

describe('ExtensionPopupView', () => {
  it('shows the Run tab by default with the credit balance', () => {
    render(<ExtensionPopupView boards={boards} jobs={jobs} creditBalance={10} applications={applications} onBoardAction={() => {}} onSignOut={() => {}} />)
  ...
  it('calls onSignOut when Sign out is clicked', async () => {
    ...
    const user = userEvent.setup()
    render(<ExtensionPopupView boards={boards} jobs={jobs} creditBalance={10} applications={applications} onBoardAction={() => {}} onSignOut={onSignOut} />)
  ...
  it('flips a board from start to in-progress when Start AutoApply is clicked', async () => {
    ...
    const user = userEvent.setup()
    render(<ExtensionPopupView boards={boards} jobs={jobs} creditBalance={10} applications={applications} onBoardAction={onBoardAction} onSignOut={() => {}} />)
