export type AdminModuleId = 'dashboard' | 'activity' | 'accounts' | 'transactions' | 'products' | 'feature-flags' | 'configuration' | 'systems' | 'analytics' | 'content' | 'messaging' | 'support' | 'kpis'
