...
export const adminProducts: readonly AdminProductRow[] = [
  ...
  },
  {
    ...
    name: 'Done For You',
    summary: 'A success manager applies on the client behalf, 50 or 100 jobs.',
    status: 'live',
    saleModel: 'package',
    includedTiers: [],
    tierNote: 'Committed packages, $497 for 50 jobs and $997 for 100',
    activeUsers: 214,
    sessionsInRange: 642,
    creditsConsumed: 0,
...
export const adminDoneForYouApplicants: readonly AdminDoneForYouApplicant[] = [
  {
    id: 'dfy_appl_001',
  ...
  },
  {
    ...
    targetCompany: 'Snowflake',
    startedLabel: 'Sep 2, 2026',
    assignedSuccessManager: 'Rachel Adeyemi',
    pipelineStatus: 'in-progress',
    packageId: 'dfy-small',
  ...
  },
  {
    ...
    targetCompany: 'Instacart',
    startedLabel: 'Aug 15, 2026',
    assignedSuccessManager: 'Rachel Adeyemi',
    pipelineStatus: 'completed',
    packageId: 'dfy-large',
...
const DETAIL_CONFIG: Readonly<Record<AdminProductSku, DetailConfig>> = {
  ...
  'done-for-you': {
    ...
    sessionCount: 26,
    errorGroups: [
      { id: 'dfy-e1', reason: 'Success manager could not reach the client for approval', count: 4, sharePercent: 67, lastSeenLabel: 'Yesterday', severity: 'warning' },
      { id: 'dfy-e2', reason: 'Client withdrew the target role before submission', count: 2, sharePercent: 33, lastSeenLabel: '3 days ago', severity: 'info' },
    ],
  },
  marketplace: {
...
function buildDetail(product: AdminProductRow, sessionCount: number): AdminProductDetail {
  ...
  return {
    ...
    stats: buildStats(product, config),
    trend: buildTrend(product.sessionsInRange, product.creditsConsumed),
    sessions: buildSessions(product.id, sessionCount),
    ...(product.id === 'done-for-you' ? { doneForYouLeads: adminDoneForYouLeads, doneForYouApplicants: adminDoneForYouApplicants } : {}),
