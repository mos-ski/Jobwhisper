...
export const downloadItems: readonly DownloadItem[] = [
  {
    ...
    extension: 'dmg',
    cta: 'macOS — Apple Silicon',
    support: 'Apple Silicon (M-series)',
  ...
  },
  {
    ...
    extension: 'AppImage',
    cta: 'Coming soon',
    support: 'Ubuntu, Debian, Fedora (x86_64)',
  ...
  },
  {
    ...
    extension: 'Chrome',
    cta: 'Download',
    support: 'Any Chromium browser — Chrome, Brave, Edge',
...
export const billingPlans: readonly BillingPlanCard[] = [
  {
    ...
    features: ['Unlimited live interview sessions', 'Interview Copilot (web + desktop)', 'Knowledge Base with 3 documents'],
  ...
  },
  {
    ...
    features: ['Everything in Starter', 'Interview Prep', 'Coding Copilot & Meeting Copilot', 'Auto Apply & Resume Builder', 'Knowledge Base with 5 documents'],
  ...
  },
  {
    ...
    annualPrice: '$4,776',
    annualCadence: 'per year',
    annualDiscountPrice: '$398',
    included: 'Unlimited use',
    description: 'Pro, plus a recording of every session and priority support.',
    features: ['Everything in PRO', 'Call recording for every session', 'Priority support', 'Knowledge Base with 10 documents'],
...
export const accountFaqs: readonly AccountFaqEntry[] = [
  ...
  // Referrals
  { category: 'Referrals', question: 'How does the referral program work?', answer: 'Share your referral link, when someone signs up through it and subscribes to a paid plan, you earn 100 free credits added to your balance.' },
