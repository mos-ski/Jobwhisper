...
const events: readonly AdminActivityEvent[] = [
  ...
  { id: 'act_012', kind: 'payment', actorName: 'Samuel Boateng', actorEmail: 'samuel.boateng@example.com', detail: 'Done-For-You package · 10 interviews guaranteed', amountCents: 49_700, timeAgo: '38 minutes ago', href: '/admin/transactions/txn_8C6VJT' },
  ...
  { id: 'act_030', kind: 'payment', actorName: 'Zainab Al-Rashid', actorEmail: 'zainab.alrashid@example.com', detail: 'Done-For-You package · 20 interviews guaranteed', amountCents: 99_700, timeAgo: '18 hours ago', href: '/admin/transactions/txn_7P3VBK' },
