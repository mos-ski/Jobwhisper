...
const FAQS = [
  ['Is Jobwhisper free to start?', 'Yes. You can create an account and try it without a card. Paid plans begin at $19 for a week of unlimited Interview Copilot.'],
  ...
  ['What does it cost?', 'Starter is $19 a week for unlimited Interview Copilot on web and desktop. Pro is $99 a month, or $79 a month paid annually, and adds Interview Prep, Coding and Meeting Copilot, Auto Apply and Resume Builder — all unlimited. Premium adds call recording and priority support. Without a plan you can still buy Resume Builder from $5 and Auto Apply from $10. Done-For-You is a one-time package. The pricing page has the full breakdown.'],
