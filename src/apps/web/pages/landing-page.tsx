...
const FAQS = [
  ['Is Jobwhisper free to start?', 'Yes. You can create an account and try it without a card. Paid plans begin at $47 for a week of unlimited Interview Copilot.'],
  ...
  ['What does it cost?', 'Starter is $47 a week for unlimited Interview Copilot on web and desktop. Pro is $99 a month and adds Interview Prep, Coding and Meeting Copilot, Auto Apply and Resume Builder — all unlimited. Premium is $497 a month and adds call recording and priority support. Without a plan you can buy what you need as you go: interview minutes at $0.10, resume prompts at $0.10, applications at $1 each. Done-For-You is a one-time package. The pricing page has the full breakdown.'],
