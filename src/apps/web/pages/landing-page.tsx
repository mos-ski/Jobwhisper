...
const FAQS = [
  ...
  ['What does it cost?', 'Starter is $47 a week for unlimited Interview Prep and Interview Copilot, on web, desktop and mobile. Pro is $99 a month, or $79 a month paid annually, and adds Meeting and Coding Copilot, Resume Builder, and Auto Apply for 500 jobs a month. Premium is $497 a month, or $398 annually, and takes the job cap off Auto Apply. Call recording is included on every plan. Without a plan you can buy what you need as you go: interview minutes at $0.10, resume prompts at $0.10, applications at $1 each. Done-For-You is a one-time package. The pricing page has the full breakdown.'],
